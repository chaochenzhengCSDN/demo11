...
public class WorkflowRequestInfo  implements java.io.Serializable {
    ...
    public String toString() {
        return "WorkflowRequestInfo{" +
                ...
                ", mustInputRemark=" + mustInputRemark +
                ...
                ", status='" + status + '\'' +
                ", subbackButtonName='" + subbackButtonName + '\'' +
                ", submitButtonName='" + submitButtonName + '\'' +
                ", subnobackButtonName='" + subnobackButtonName + '\'' +
                ", workflowBaseInfo=" + workflowBaseInfo +
                ", workflowDetailTableInfos=" + Arrays.toString(workflowDetailTableInfos) +
                ", workflowHtmlShow=" + Arrays.toString(workflowHtmlShow) +
                ", workflowHtmlTemplete=" + Arrays.toString(workflowHtmlTemplete) +
                ", workflowMainTableInfo=" + workflowMainTableInfo +
                ", workflowPhrases=" + Arrays.toString(workflowPhrases) +
                ", workflowRequestLogs=" + Arrays.toString(workflowRequestLogs) +
